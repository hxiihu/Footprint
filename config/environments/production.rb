Rails.application.configure do
  ...
  # To configure our application to use SendGrid, we need to fill out the SMTP settings for our production environment.
  # You will also have to define a host variable with the address of your production website.
  config.action_mailer.raise_delivery_errors = true
  config.action_mailer.delivery_method = :smtp
  host = 'yurilliam.herokuapp.com'
  config.action_mailer.default_url_options = { host: host }
  ActionMailer::Base.smtp_settings = {
    #1 :address        => 'smtp.sendgrid.net',
